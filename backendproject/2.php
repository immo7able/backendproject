...
<body>
	...
	<section class="shop-section">
		<div class="container">
			<div class="row">
			<?php 
			$sql="SELECT * FROM products WHERE id_products IN (2) ORDER BY name ASC"; 
			...
			?> 
				<div class="shop-main"> 
					...
					<div class="cart-add custom-btn btn-3"><a href="2.php?page=products&action=add&id_products=<?php echo $row['id_products']; ?>">Добавить в корзину</a></div>
				</div><!--end of main-->  
